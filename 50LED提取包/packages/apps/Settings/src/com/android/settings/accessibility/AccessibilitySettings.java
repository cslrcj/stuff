...
import android.os.SystemProperties;//hejianfeng add for hall
/**
...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    //modify by even hejianfeng@20150601 hall menu
    private static final String HALL_SETTING = "hall_setting";
    ...
    /// zgz: add nlight settings
    private static final String NLIGHT_SETTING_PREFERENCE = "nlight_setting";
    ...
    /// zgz: nlight preference
    private SwitchPreference nLightSetting;

    //modify by even hejianfeng@20150601 hall menu
    private SwitchPreference mHallSetting;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (mSelectLongPressTimeoutPreference == preference) {
            ...
            Settings.System.putInt(getContentResolver(), Settings.System.IPO_SETTING,
                ...
                return true;
             /** @} */
        }else if (nLightSetting == preference) {
            /** zgz:  add nlight settings @{ */
            Settings.System.putInt(getContentResolver(), Settings.System.NLIGHT_SETTING,
                    (Boolean) newValue ? 1 : 0);
                return true;
             /** @} */
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (mToggleLargeTextPreference == preference) {
            ...
            return true;
        }else if (mHallSetting == preference) {
            boolean isChecked = ((SwitchPreference) preference).isChecked();
            Settings.System.putInt(getContentResolver(), Settings.System.HALL_SETTING,
                    isChecked ? 1 : 0); 
            return true;//modify by even hejianfeng@20150601 hall menu
        } 
    ...
    private void initializeAllPreferences() {
		...
		/// zgz: NLIGHT settings
        nLightSetting = (SwitchPreference) findPreference(NLIGHT_SETTING_PREFERENCE);
        nLightSetting.setOnPreferenceChangeListener(this);
        //mSystemsCategory.removePreference(nLightSetting);
		
		//modify by even  hejianfeng@20150601 hall menu	
        mHallSetting = (SwitchPreference) findPreference(HALL_SETTING);
        if (!SystemProperties
            .get("ro.magcomm_hall_support").equals("1")) {
            mSystemsCategory.removePreference(mHallSetting);
        }
    ...
    private void updateSystemPreferences() {
		...
		/// zgz: NLIGHT Setting @{
        boolean nlightSettingEnabled = Settings.System.getInt(getContentResolver(),
                Settings.System.NLIGHT_SETTING, 1) == 1;
        if (nLightSetting != null) {
            nLightSetting.setChecked(nlightSettingEnabled);
        }
        /// @} end
		//modify by even hejianfeng@20150601 hall menu
		boolean hallSettingEnabled = Settings.System.getInt(getContentResolver(),
                Settings.System.HALL_SETTING,1) == 1;
        if (mHallSetting != null) {
        	mHallSetting.setChecked(hallSettingEnabled);   
        }
	}
        //hejianfeng@20150601 end
