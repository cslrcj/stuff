...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
		...
		*/
		...
		/**
         * zgz add Enable fast NotificationLight? true = yes false = no
         * 
         * @hide
         */
        public static final String NLIGHT_SETTING = "nlight_setting";
       ...
       /**
        ...
        public static boolean canWrite(Context context) {
         ...
         //bruce _hucheng add touchletter start
         /**
         * @hide
         */
         public static final String BODY_FEELING_SETTING = "body_feeling_setting";
         /**
         * @hide
         */
         public static final String FREE_SCREENSHOTS_SETTING = "free_screenshots_setting";
         /**
         * @hide
         */
         public static final String TOUCHLETTER_ONOFF = "touch_letter_onoff";
         /**
         * @hide
         */
         public static final String TOUCHSWITCH_MUSIC_ONOFF = "touch_switch_music_onoff";
         /**
         * @hide
         */
         public static final String DOUBLE_SCREEN_ONOFF = "double_screen_onoff";
      
        /* added by bruce for air shuffle begin */
		/**
         * @hide
         */
         public static final String TOUCHPS_ONOFF = "touch_ps_onoff";
		 
        /**
         * Air Shuffle Music Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String AIR_SHUFFLE_MUSIC_SETTING = "air_shuffle_music_setting";

        /**
         * Air Shuffle Launcher Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String AIR_SHUFFLE_LAUNCHER_SETTING = "air_shuffle_launcher_setting";

        /**
         * Air Shuffle Image Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String AIR_SHUFFLE_IMAGE_SETTING = "air_shuffle_image_setting";

        /**
         * Air Shuffle Camera Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String AIR_SHUFFLE_CAMERA_SETTING = "air_shuffle_camera_setting";

        /**
         * Air Shuffle FM Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String AIR_SHUFFLE_FM_SETTING = "air_shuffle_fm_setting";
        /* added by bruce for air shuffle end */	

         /* added by bruce for screen on gesture begin */	

        /**
         * Screen on Gesture Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_GESTURE_SETTING = "screenon_gesture_setting";

        /**
         * Multi Finger Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_MULTIFINGER_SETTING = "screenon_multifinger_setting";

        /**
         * Double Click Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_DOUBLECLICK_SETTING = "screenon_doubleclick_setting";

        /**
         * Three Finger Screenshot Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_THREEFINGER_SETTING = "screenon_threefinger_setting";

        /**
         * Double Finger Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_DOUBLEFINGER_SETTING = "screenon_doublefinger_setting";

        /**
         * Single hand Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_SINGLEHAND_SETTING = "screenon_singlehand_setting";

        /**
         * Glove mode Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String SCREENON_GLOVEMODE_SETTING = "screenon_glove_setting";
        /* added by bruce for screen on gesture end */

        /**
		 * added by bruce for touch photo
         * @hide
         */
        public static final String MAGCOMM_TOUCH_PHOTO = "magcomm_touch_photo";
		
		/**
		 * added by bruce for touch photo control back/front camera
         * @hide
         */
        public static final String MAGCOMM_TOUCH_PHOTO_BACK = "magcomm_touch_photo_back";

        /**
		 * added by bruce for touch photo control back/front camera
         * @hide
         */
        public static final String MAGCOMM_TOUCH_PHOTO_FRONT = "magcomm_touch_photo_front";

        /**
         * added by bruce for touch photo control back/front camera
         * @hide
         */
        public static final String MAGCOMM_CAMERA_ID = "magcomm_camera_id";

        /* added by bruce for touch photograph begin */	
        /**
         * Three Touch Photograph Enable ? true = yes false = no
         * 
         * @hide
         */
        public static final String MAGCOMM_TOUCH_PHOTOGRAPH = "magcomm_touch_photograph_setting";
        /* added by bruce for touch photograph end */

        /** added by bruce for modified lock wallpaper
         * Lock Wallpaper Id
         * 
         * @hide
         */
        public static final String MAGCOMM_LOCK_WALLPAPER_ID = "magcomm_lock_wallpaper_id";
		//bruce _hucheng add touchletter end
    }
