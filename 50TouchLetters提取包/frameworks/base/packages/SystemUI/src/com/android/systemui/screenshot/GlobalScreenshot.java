...
class SaveImageInBackgroundData {
    ...
    int previewWidth;
    int previewheight;
    String mImageFilePath;//hejianfeng add - hucheng free screenshots
...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void,
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        data.mImageFilePath=mImageFilePath;//hejianfeng add - hucheng free screenshots
 ...
 *     type of gallery?
 */
//hejianfeng modif - hucheng free screenshots add public 
public class GlobalScreenshot {
     ...
     */
    //hejianfeng modif private -->public - hucheng free screenshots
    private SaveImageInBackgroundData data;//hejianfeng add - hucheng free screenshots
   ...
   public void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        //hejianfeng add start - hucheng free screenshots
      ...
      //hejianfeng add end - hucheng free screenshots
    }
    //hejianfeng add start - hucheng free screenshots
    public Bitmap getScreenBitmap(){
    	return mScreenBitmap;
    }
    public void setScreenBitmap(Bitmap mBitmap){
    	mScreenBitmap=mBitmap;
    }
    private boolean isAreaScreenShot;
    public void setAreaScreenShot(boolean isArea){
    	isAreaScreenShot=isArea;
    }
    public String getImageFilePath(){
    	return data.mImageFilePath;
    }
    //hejianfeng add end - hucheng free screenshots
