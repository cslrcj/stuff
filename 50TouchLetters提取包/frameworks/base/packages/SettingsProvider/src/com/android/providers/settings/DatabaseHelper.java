...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //bruce _hucheng add start,  touchletter
            loadBooleanSetting(stmt, Settings.System.TOUCHLETTER_ONOFF,
                    R.bool.def_touchletter_setting);
            loadBooleanSetting(stmt, Settings.System.DOUBLE_SCREEN_ONOFF,
                    R.bool.def_touchletter_double_screen_setting);
            loadBooleanSetting(stmt, Settings.System.TOUCHSWITCH_MUSIC_ONOFF,
                    R.bool.def_touchletter_switch_music_setting);
            loadBooleanSetting(stmt, Settings.System.TOUCHPS_ONOFF,
                    R.bool.def_touchps_setting);
            //bruce _hucheng add end, touchletter
            // added by bruce _hucheng for air shuffle begin           
            loadBooleanSetting(stmt, Settings.System.AIR_SHUFFLE_MUSIC_SETTING,
                    R.bool.def_airshuffle_music_setting);
            loadBooleanSetting(stmt, Settings.System.AIR_SHUFFLE_LAUNCHER_SETTING,
                    R.bool.def_airshuffle_launcher_setting);
            loadBooleanSetting(stmt, Settings.System.AIR_SHUFFLE_IMAGE_SETTING,
                    R.bool.def_airshuffle_image_setting);
            loadBooleanSetting(stmt, Settings.System.AIR_SHUFFLE_CAMERA_SETTING,
                    R.bool.def_airshuffle_camera_setting);
            loadBooleanSetting(stmt, Settings.System.AIR_SHUFFLE_FM_SETTING,
                    R.bool.def_airshuffle_fm_setting);
            // added by bruce _hucheng for air shuffle end
            // added by bruce _hucheng for screen on gesture begin
            loadBooleanSetting(stmt, Settings.System.SCREENON_GESTURE_SETTING,
                    R.bool.def_screenon_gesture_setting);
            loadBooleanSetting(stmt, Settings.System.SCREENON_MULTIFINGER_SETTING,
                    R.bool.def_screenon_multifinger_setting);
            loadBooleanSetting(stmt, Settings.System.SCREENON_DOUBLECLICK_SETTING,
                    R.bool.def_screenon_doubleclick_setting);
            loadBooleanSetting(stmt, Settings.System.SCREENON_THREEFINGER_SETTING,
                    R.bool.def_screenon_threefinger_setting);
            loadBooleanSetting(stmt, Settings.System.SCREENON_DOUBLEFINGER_SETTING,
                    R.bool.def_screenon_doublefinger_setting);
            loadBooleanSetting(stmt, Settings.System.SCREENON_SINGLEHAND_SETTING,
                    R.bool.def_screenon_singlehand_setting);         
            loadBooleanSetting(stmt, Settings.System.BODY_FEELING_SETTING,
                    R.bool.def_body_feeling_setting);
            loadBooleanSetting(stmt, Settings.System.FREE_SCREENSHOTS_SETTING,
                    R.bool.def_free_screenshots_setting);     
            ...
            //default 12-24 by lixiang 20160818
