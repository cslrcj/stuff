...
// added by bruce _ hucheng for three finger screenshot end
...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        Log.i("bruce_nan", "View_dispatchTouchEvent_nfl: screenonEnable = " + screenonEnable);
        if (screenonEnable){
            ...
            Log.i("bruce_nan", "View_dispatchTouchEvent_nfl_01: threefingerEnable = " + threefingerEnable + "; pointCount = " + pointCount);
            if (threefingerEnable && (pointCount >= 3) && (event.getAction() == MotionEvent.ACTION_MOVE)){
                return true;
            }
        }
