...
public class WallpaperCropActivity extends Activity {
	...
	private View mSetLockWallpaperButton;//hejianfeng add 
        ...
        mSetWallpaperButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        cropImageAndSetWallpaper(imageUri, null, finishActivityWhenDone, false);
                    }
                });
		mSetLockWallpaperButton = findViewById(R.id.set_lock_wallpaper_button);
        mSetLockWallpaperButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        cropImageAndSetWallpaper(imageUri, null, finishActivityWhenDone,true);
                    }
                });
        if(!android.os.SystemProperties
                .get("ro.launcher_lock_wallpapers").equals("1")){
        	mSetLockWallpaperButton.setVisibility(View.GONE);
        }
		//hejianfeng modif end 
        // Load image in background
        final BitmapRegionTileSource.UriBitmapSource bitmapSource =
                new BitmapRegionTileSource.UriBitmapSource(this, imageUri, 1024);
        mSetWallpaperButton.setVisibility(View.INVISIBLE);
		//caiji add for bug when setting screenlock wallpaper too fast
		mSetLockWallpaperButton.setVisibility(View.INVISIBLE);
        Runnable onLoad = new Runnable() {
            public void run() {
                if (bitmapSource.getLoadingState() != BitmapSource.State.LOADED) {
					...
					//caiji add for bug when setting screenlock wallpaper too fast
                    mSetLockWallpaperButton.setVisibility(View.VISIBLE);
                }
            }
        };
    ...
    static protected Point getDefaultWallpaperSize(Resources res, WindowManager windowManager) {
		...
		//weiyawei modify start
	      ...
	      sDefaultWallpaperSize = new Point(1080, 1920);
		//weiyawei modify end
        }
    ...
    protected void cropImageAndSetWallpaper(Uri uri,
            OnBitmapCroppedHandler onBitmapCroppedHandler, final boolean finishActivityWhenDone,boolean isLock) {//hejianfeng modif
        ...
        //hejianfeng add start
        cropTask.setLockWallpaper(isLock);
        //hejianfeng add end 
        cropTask.execute();
    }
    ...
    protected static class BitmapCropTask extends AsyncTask<Void, Void, Boolean> {
        ...
        boolean mNoCrop;
        boolean isLockWallpaper;//hejianfeng add 
        ...
        //hejianfeng add start
        public void setLockWallpaper(boolean value){
        	isLockWallpaper=value;
        }
        //hejianfeng add end
        ...
        private void setSteamWallpaper(InputStream data) throws IOException {
        	...
        	Log.w(LOGTAG, "hejianfeng mImageFilePath="+mImageFilePath.getAbsolutePath());
            ...
            Settings.System.putInt(mContext.getContentResolver(),
                    Settings.System.MAGCOMM_LOCK_WALLPAPER_ID, 0);
        }
        private void setLockWallpaper(InputStream data, FileOutputStream fos)
                throws IOException {
                ...
                if (crop.compress(cf, DEFAULT_COMPRESS_QUALITY, tmpOut)) {
                    ...
                    if (mSetWallpaper && wallpaperManager != null) {
                        try {
                          ...
                          //hejianfeng add start
                        	if(isLockWallpaper){
                        		setSteamWallpaper(new ByteArrayInputStream(outByteArray));
                        	}else{
