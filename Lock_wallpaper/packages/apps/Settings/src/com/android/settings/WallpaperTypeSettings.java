...
public class WallpaperTypeSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private void populateWallpaperTypes() {
        ...
        parent.addPreference(createLockWallpaperPref());
		}
		//hejianfeng add end
    }
    //hejianfeng add start
    private Preference createLockWallpaperPref(){
    	Preference pref = new Preference(getActivity());
    	...
    	pref.setIntent(prefIntent);
    	pref.setTitle(getActivity().getResources().getString(R.string.lock_wallpapers));
    	return pref;
    }
    //hejianfeng add end
