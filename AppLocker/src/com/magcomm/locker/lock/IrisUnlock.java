 ...
 *
 */
public class IrisUnlock implements Handler.Callback{
	 private static final boolean DEBUG = true;
	    private static final String TAG = "Irisockscreen";
	    ...
	    private IrisLockListener mIrisLockListener;
	    /**
	     ...
	     */
	    public IrisUnlock(Context context) {
	        mContext = context;
	        mHandler = new Handler(this);
	    }
	    public void setOnIrisLockListener(IrisLockListener irisLockListener){
	    	mIrisLockListener=irisLockListener;
	    }
	    /**
	    ...
	    public boolean start() {
	        ...
	        if (!mBoundToService) {
	            ...
	            Log.d(TAG, "jeff getName="+IFaceLockInterface.class.getName());
	            mContext.bindServiceAsUser(new Intent(IFaceLockInterface.class.getName()).setPackage(FACE_LOCK_PACKAGE),
	                    mConnection,
	    ...
	    void handleUnlock(int authenticatedUserId) {
	        ...
	        if (authenticatedUserId == currentUserId) {
	            ...
	            mIrisLockListener.IrisSuccess();//hejianfeng add
