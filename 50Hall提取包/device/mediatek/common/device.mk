...
# added by hucheng for touchletters
ifeq ($(strip $(MAGCOMM_TOUCHLETTER_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.magcomm_touch_support =1
  PRODUCT_PACKAGES += TouchLetters
endif
#hejianfeng add start for screen shot 
ifeq ($(strip $(MAGCOMM_SCREEN_SHOT_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.magcomm_screen_shot_support=1
endif
#hejianfeng add end 
# hejianfeng add for hall
ifeq ($(strip $(MAGCOMM_HALL_SUPPORT)),yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.magcomm_hall_support=1
  PRODUCT_PACKAGES += Hall
endif
