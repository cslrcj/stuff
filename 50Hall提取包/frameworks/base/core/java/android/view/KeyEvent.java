...
public class KeyEvent extends InputEvent implements Parcelable {
	...
	//hejianfeng@20150601 add end
// added by bruce _hucheng for touchletter begin
    /**
     * @hide
     */
    public static final int KEYCODE_TP_DBL         = 288;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_C           = 289;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_E           = 290;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_M           = 291;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_O           = 292;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_UP           = 293;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_DOWN         = 294;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_LEFT         = 295;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_RIGHT        = 296;

    /**
     * @hide
     */
    public static final int KEYCODE_TP_W            = 297;
    // added by bruce _hucheng for touchletter end

    private static final int LAST_KEYCODE = KEYCODE_TP_W;
