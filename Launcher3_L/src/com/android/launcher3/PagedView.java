...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        ///M. ALPS02275604. init mPageScrollsOr.
        if (mPageScrollsOr == null || getChildCount() != mChildCountOnLastLayout) {
            mPageScrollsOr = new int[getChildCount()];
        }
        ///M.
        ...
        ///M. ALPS02257224, call snapToPage after onLayout.
        ///Because mPageScrolls maybe modify.
        if (this instanceof Workspace) {
            int page = getCurrentPage();
            ///M. ALPS02304780, check arrary index out of bound or not.
            if (page < mChildCountOnLastLayout) {
                ///M. ALPS02275604, check the mPageScrolls is modify or not.
                if (mPageScrollsOr[page] != mPageScrolls[page]) {
                    snapToPage(page, 0);
                    mPageScrollsOr[page] = mPageScrolls[page];
                }
            }
        }
        ///M.
