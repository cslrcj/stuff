...
public class CellLayout extends ViewGroup {
	...
	public static final int addPadding=20;//hejianfeng add 
...
out:            for (int i = x; i < x + spanX - 1 && x < xCount; i++) {
    ...
    public int getDesiredWidth() {
        return getPaddingLeft() + getPaddingRight() + ((mCountX+1) * (mCellWidth-addPadding)) +
                (Math.max((mCountX - 1), 0) * mWidthGap);//hejianfeng modif
    }
