...
public class LauncherProvider extends ContentProvider {
    ...
    static final String TABLE_ICONCOLOR = "iconColor";//hejianfeng add 
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            addIconcolorTable(db);//hejianfeng add 
        ...
        private void addIconcolorTable(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + TABLE_ICONCOLOR + " (" +
                    LauncherSettings.Favorites._ID + " INTEGER," +
                    LauncherSettings.IconColor.NAME + " TEXT," +
                    LauncherSettings.IconColor.COLOR + " INTEGER," +
                    LauncherSettings.ChangeLogColumns.MODIFIED + " INTEGER NOT NULL DEFAULT 0"+
                    ");");
        }
      //hejianfeng add end
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version != DATABASE_VERSION) {
                ...
                db.execSQL("DROP TABLE IF EXISTS " + TABLE_ICONCOLOR);//hejianfeng add 
