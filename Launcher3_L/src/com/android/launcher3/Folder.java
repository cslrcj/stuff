...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        mMaxCountX = (int) grid.numColumns-1;//hejianfeng modif
    ...
    protected void onFinishInflate() {
        ...
        mContent.setCellDimensions(grid.folderCellWidthPx+mContent.addPadding,
                LauncherExtPlugin.getInstance().getWorkspaceExt(getContext())
                        .customizeFolderCellHeight(grid.folderCellHeightPx)+mContent.addPadding);//hejianfeng modif 
		...
		mTitleBottom = findViewById(R.id.title_bottom);
		//hejianfeng add end 
    }
	//hejianfeng add start 
    ...
    private int getFolderHeight() {
        int height = getPaddingTop() + getPaddingBottom()
                + getContentAreaHeight() + mFolderNameHeight+40;//hejianfeng modif 
        return height;
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        */
        ...
        /**@}*/
		//hejianfeng add start 
		mTitleBottom.measure(contentAreaWidthSpec-100, MeasureSpec.makeMeasureSpec(2, MeasureSpec.EXACTLY));
		//hejianfeng add end 
